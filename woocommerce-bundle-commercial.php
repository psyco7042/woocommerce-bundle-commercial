...
wp_enqueue_style('wbc-main', plugins_url('assets/css/wbc-main.css', __FILE__), array('virtual-select'), filemtime(plugin_dir_path(__FILE__) . 'assets/css/wbc-main.css'), 'all');
wp_enqueue_script('wbc-main', plugins_url('assets/js/wbc-main.js'), array('jquery', 'virtual-select'), filemtime(plugin_dir_path(__FILE__) . 'assets/js/wbc-main.js'), true);
